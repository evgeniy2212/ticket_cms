<div class="col-xl-8 ui-sortable">
    <div class="form-group row m-b-15">
        ...
        <div class="col-md-9 col-sm-9">
            {{ Form::text('alias', (isset($page)) ? $page->alias : null, ['id'=>'pageAlias','class' => 'form-control','placeholder'=>__('backend.alias')]) }}
    ...
    <div class="form-group row m-b-15">
        ...
        <div class="col-md-9 col-sm-9">
            {!! Form::text('title', (isset($page)) ? $page->title : null,['id'=>'pageTitle', 'class'=>'form-control','placeholder'=>__('backend.page_title'), 'required', 'data-parsley-required']) !!}
        </div>
    </div>
    <div class="form-group row m-b-15">
        <label class="col-md-3 col-sm-3 col-form-label text-lg-right" for="summernote">@lang('backend.page_content')* :</label>
        <div class="col-md-9 col-sm-9">
            {!! Form::textarea('text', (isset($page)) ? $page->text : null,['id'=>'summernote', 'class'=>'form-control','placeholder'=>__('backend.page_content'),'required', 'data-parsley-required']) !!}
        </div>
    </div>
    <div class="form-group row m-b-15">
        ...
        <div class="col-md-9 col-sm-9">
            ...
            <div class="switcher">
                {!! Form::checkbox('active', 1, (isset($page)) ? $page->active : null, ['id' => 'switcher-active']) !!}
