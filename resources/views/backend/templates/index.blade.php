...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">@lang('backend.templates')</li>
    </ol>
    <!-- end breadcrumb -->

    <!-- begin page-header -->
    <h1 class="page-header">@lang('backend.templates') </h1>
    <!-- end page-header -->
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading">
            <h4 class="panel-title">@lang('backend.templates')</h4>
                    ...
                    <tr class="@if($loop->iteration  % 2 == 0) even @else odd @endif gradeA">
                        ...
                        <td>
                            @include('backend.elements.edit_buttons', [
                                ...
                                'destroy_link' => route('backend.templates.destroy',['template' => $template]),
                                'template'        => $template,
                            ])
                        </td>
                    </tr>
